...
func (m *HelloWorldResponse) GetEcho() string {
	if m != nil {
		return m.Echo
	}
	return ""
...
func init() {
	proto.RegisterType((*HelloWorldRequest)(nil), "hw.HelloWorldRequest")
	proto.RegisterType((*HelloWorldResponse)(nil), "hw.HelloWorldResponse")
}
...
func (c *helloWorldClient) HelloWorld(ctx context.Context, in *HelloWorldRequest, opts ...grpc.CallOption) (*HelloWorldResponse, error) {
	...
	err := grpc.Invoke(ctx, "/hw.HelloWorld/HelloWorld", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _HelloWorld_HelloWorld_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hw.HelloWorld/HelloWorld",
	}
...
var fileDescriptor0 = []byte{
	...
	0xc9, 0x2f, 0xcf, 0x2f, 0xca, 0x49, 0xd1, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x62, 0xca, 0x28,
	0x57, 0x52, 0xe7, 0x12, 0xf4, 0x00, 0x89, 0x87, 0x83, 0xc4, 0x83, 0x52, 0x0b, 0x4b, 0x53, 0x8b,
	0x4b, 0x84, 0x84, 0xb8, 0x58, 0xf2, 0x12, 0x73, 0x53, 0x25, 0x18, 0x15, 0x18, 0x35, 0x38, 0x83,
	0xc0, 0x6c, 0x25, 0x0d, 0x2e, 0x21, 0x64, 0x85, 0xc5, 0x05, 0xf9, 0x79, 0xc5, 0xa9, 0x20, 0x95,
	0xa9, 0xc9, 0x19, 0xf9, 0x12, 0x4c, 0x10, 0x95, 0x20, 0xb6, 0x91, 0x37, 0x17, 0x17, 0x42, 0xa5,
	0x90, 0x2d, 0x0a, 0x4f, 0x54, 0x2f, 0xa3, 0x5c, 0x0f, 0xc3, 0x42, 0x29, 0x31, 0x74, 0x61, 0x88,
	0xf1, 0x4a, 0x0c, 0x49, 0x6c, 0x60, 0xa7, 0x1a, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0x37, 0x43,
	0x16, 0x15, 0xbe, 0x00, 0x00, 0x00,
}
