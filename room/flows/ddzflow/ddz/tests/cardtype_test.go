...
func Test_CardSort(t *testing.T) {
	cards := []uint32{0x0F, 0x0E, 0x42, 0x22, 0x21, 0x11, 0x1D, 0x2C, 0x2B, 0x1B, 0x3A, 0x49, 0x48, 0x37, 0x26, 0x15, 0x34, 0x13} //大王、小王、22、AA、KQJJ 10 9876543
