...
func GetDeskPlayerByID(d interfaces.Desk, playerID uint64) interfaces.DeskPlayer {
...
func GetDeskPlayerIDs(d interfaces.Desk) []uint64 {
	players := d.GetDeskPlayers()
...
func GetTuoguanPlayers(desk interfaces.Desk) []uint64 {
