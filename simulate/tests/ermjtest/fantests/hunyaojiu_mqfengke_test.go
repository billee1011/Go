...
//Test_hunYaoJiu_MQFengKe_ziMo 混幺九 门风刻 圈风刻
//步奏:庄家天胡自摸
//期望:所有玩家收到结算通知

func Test_hunYaoJiu_ziMo(t *testing.T) {
	...
	params.IsHsz = false
	params.Cards = [][]uint32{
		{11, 11, 11, 19, 19, 19, 41, 41, 41, 43, 43, 43, 46},
		{17, 18, 12, 16, 17, 18, 17, 18, 12, 17, 18, 12, 12},
	}
	params.WallCards = []uint32{46, 42, 42, 24}
	...
	// 检查番结算 天胡 88,无花 4,混幺九 32,圈风刻 2,门风刻 2,混一色 6,四暗刻 64 = 198
	utils.CheckFanSettle(t, deskData, params.GameID, banker, 198, room.FanType_FT_HUNYAOJIU)
}
