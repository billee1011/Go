...
//Test_xiaoSanYuan_ziMo 小三元
//步奏:庄家天胡自摸
//期望:所有玩家收到结算通知

func Test_xiaoSanYuan_ziMo(t *testing.T) {
	...
	params.IsHsz = false
	params.Cards = [][]uint32{
		{11, 11, 11, 12, 12, 12, 45, 45, 45, 46, 46, 46, 47},
		{17, 18, 19, 16, 17, 18, 17, 18, 19, 17, 18, 19, 19},
	}
	params.WallCards = []uint32{47, 13, 13, 13}
	...
	// 检查番结算 天胡 88,无花 4,小三元 64,混一色 6,四暗刻 64 = 226
	utils.CheckFanSettle(t, deskData, params.GameID, banker, 226, room.FanType_FT_XIAOSANYUAN)
}
