...
//Test_sanYuanQiDui_ziMo 三元七对
//步奏:庄家天胡自摸
//期望:所有玩家收到结算通知

func Test_sanYuanQiDui_ziMo(t *testing.T) {
	...
	params.IsHsz = false
	params.Cards = [][]uint32{
		{11, 11, 12, 12, 41, 41, 43, 43, 45, 45, 46, 46, 47},
		{17, 18, 19, 16, 17, 18, 17, 18, 19, 17, 18, 19, 19},
	}
	params.WallCards = []uint32{47, 42, 42, 24}
	...
	// 检查番结算 天胡 88,无花 4,三元七对 48,混一色 6 = 146
	utils.CheckFanSettle(t, deskData, params.GameID, banker, 146, room.FanType_FT_SANYUANQIDUI)
}
