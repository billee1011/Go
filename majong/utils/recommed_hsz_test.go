...
func Benchmark_CardNum_sanTiao(t *testing.B) {
	...
	hszCards := gutils.GetRecommedHuanSanZhang(cards)
	...
	hszCards2 := gutils.GetRecommedHuanSanZhang(cards2)
	...
	hszCards3 := gutils.GetRecommedHuanSanZhang(cards3)
	...
	hszCards4 := gutils.GetRecommedHuanSanZhang(cards4)
	...
	hszCards5 := gutils.GetRecommedHuanSanZhang(cards5)
	...
	hszCards6 := gutils.GetRecommedHuanSanZhang(cards6)
	...
	hszCards7 := gutils.GetRecommedHuanSanZhang(cards7)
	...
	hszCards8 := gutils.GetRecommedHuanSanZhang(cards8)
...
func Test_DingCard_You1And9(t *testing.T) {
	...
	hszCards1 := gutils.GetRecommedHuanSanZhang(cards1)
