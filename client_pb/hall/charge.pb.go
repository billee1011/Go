...
func (*ChargeItem) Descriptor() ([]byte, []int) {
	return fileDescriptor_charge_b80c3ba61dd764a9, []int{0}
}
...
func (*GetChargeInfoReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_charge_b80c3ba61dd764a9, []int{1}
}
...
func (*GetChargeInfoRsp) Descriptor() ([]byte, []int) {
	return fileDescriptor_charge_b80c3ba61dd764a9, []int{2}
}
...
func (*ChargeReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_charge_b80c3ba61dd764a9, []int{3}
}
...
func (*ChargeRsp) Descriptor() ([]byte, []int) {
	return fileDescriptor_charge_b80c3ba61dd764a9, []int{4}
}
...
func init() { proto.RegisterFile("charge.proto", fileDescriptor_charge_b80c3ba61dd764a9) }

var fileDescriptor_charge_b80c3ba61dd764a9 = []byte{
