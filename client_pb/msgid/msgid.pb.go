...
const (
	...
	MsgID_HALL_GET_PLAYER_INFO_RSP MsgID = 16383
	// ROOM_BEGIN 消息区间开始
...
var MsgID_name = map[int32]string{
	...
	16383:  "HALL_GET_PLAYER_INFO_RSP",
	65536:  "ROOM_BEGIN",
...
var MsgID_value = map[string]int32{
	...
	"HALL_GET_PLAYER_INFO_RSP":     16383,
	"ROOM_BEGIN":                   65536,
...
var fileDescriptor0 = []byte{
	...
	,
}
