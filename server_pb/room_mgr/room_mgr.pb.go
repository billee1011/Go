...
type CreateDeskRequest struct {
	...
	MinCoin  uint64        `protobuf:"varint,5,opt,name=min_coin,json=minCoin" json:"min_coin,omitempty"`
	MaxCoin  uint64        `protobuf:"varint,6,opt,name=max_coin,json=maxCoin" json:"max_coin,omitempty"`
	BaseCoin uint64        `protobuf:"varint,7,opt,name=base_coin,json=baseCoin" json:"base_coin,omitempty"`
}
