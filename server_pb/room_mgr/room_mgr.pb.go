...
func (RoomError) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_room_mgr_d6d41c0ca691b3e7, []int{0}
}
...
func (*CreateDeskRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_room_mgr_d6d41c0ca691b3e7, []int{1}
}
...
func (*CreateDeskResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_room_mgr_d6d41c0ca691b3e7, []int{2}
}
...
func init() { proto.RegisterFile("room_mgr.proto", fileDescriptor_room_mgr_d6d41c0ca691b3e7) }

var fileDescriptor_room_mgr_d6d41c0ca691b3e7 = []byte{
