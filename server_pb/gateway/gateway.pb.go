...
func (*AnotherLoginRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{3} }
...
func (*AnotherLoginResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{4} }
...
func (c *gateServiceClient) AnotherLogin(ctx context.Context, in *AnotherLoginRequest, opts ...grpc.CallOption) (*AnotherLoginResponse, error) {
	...
	err := grpc.Invoke(ctx, "/gateway.GateService/AnotherLogin", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
