...
func (DDZStage) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_doudizhu_5c5c76f87a9a176e, []int{0}
}
...
type DDZContext struct {
	...
	WallCards            []uint32 `protobuf:"varint,28,rep,packed,name=wall_cards,json=wallCards,proto3" json:"wall_cards,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*DDZContext) Descriptor() ([]byte, []int) {
	return fileDescriptor_doudizhu_5c5c76f87a9a176e, []int{1}
}
...
func init() { proto.RegisterFile("doudizhu.proto", fileDescriptor_doudizhu_5c5c76f87a9a176e) }

var fileDescriptor_doudizhu_5c5c76f87a9a176e = []byte{
